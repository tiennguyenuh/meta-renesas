...
SRC_URI = "git://${GO_IMPORT};branch=master \
           ...
           file://0001-bolt:riscv64-Add-support-for-riscv64.patch;patchdir=src/github.com/golang/dep \
          "
SRC_URI:append:riscv64 = " file://0001-Update-sys-module-to-latest.patch;patchdir=src/github.com/golang/dep "
...
PTEST_ENABLED:mips = "0"
PTEST_ENABLED:mips64 = "0"
